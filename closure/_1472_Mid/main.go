...
"leetcode.com" ，并返回 "leetcode.com"
 ...
 Related Topics 栈 设计 数组 链表 数据流 双向链表 👍 109 👎 0
...
func Constructor(homepage string) BrowserHistory {
	return BrowserHistory{x: 0, history: []string{homepage}}
}

func (h *BrowserHistory) Visit(url string) {
	if h.x != len(h.history)-1 {
		h.history = h.history[:h.x+1]
	}
